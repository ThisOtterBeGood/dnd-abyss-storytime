## Level 1
* **HP:** 9 (1d8:8 + 1)
* **Klassentalent:** Point Blank Shot (+1 Angriff, +1 Schaden innerhalb von 30 ft.)
* **Bonustalent (Mensch):** Weapon Focus: Longbow (+1 Angriff)
* **Klassen-Features:** * 1. Erzfeind: Kobold (+2 Schaden)
    * Track (Spurenlesen)
    * Wild Empathy (Mit Tieren umgehen)
* **Fertigkeitspunkte:** +28 (24 Ranger + 4 Mensch)

## Level 2
* **HP:** 18 (9 + 8 max HD + 1)
* **Klassen-Feature:** Combat Style: Archery -> Verleiht das Talent **Rapid Shot** (Schnelles Schießen)
* **Fertigkeitspunkte:** +7 (Gesamt: 35)
    * *Verteilung:* Survival = 4, Spot = 3, Knowledge (Dungeoneering) = 2, Craft (Bowmaking) = 1, Climb = 4, Hide = 4, Move Silently = 4, Use Rope = 3, Swim = 3, Listen = 3, Heal = 2, Profession (Hunter) = 2
...
* **Stufe 3 Talent:** Diehard (Unverwüstlich)
* **Fertigkeitspunkte:** +7 (Gesamt: 42)
    * *Verteilung:* Survival 4+2=6, Spot 3+2=5, Knowledge (Dungeoneering) 2+2=4, Craft (Bowmaking) 1+1=2
...
* **Waldläufer-Zauber:** 1. Grad: 1 (Standard: *Delay Poison*)
* **Fertigkeitspunkte:** +7 (Gesamt: 49)
    * *Verteilung:* Heal 2+2=4, Knowledge (Dungeoneering) 4+1=5, Handle Animal 0+4=4
...
## Level 6
* **HP:** 54 (6D8 + 6)
* **Rettungswürfe:** Fort 5, Ref 5, Will 2
* **BAB:** +6/+1
* **Klassen-Features:** * Improved Combat Style: Archery -> Verleiht das Talent **Manyshot** (Mehrfachschuss)
    * Improved Initiative (+4 auf Initiative-Würfe)
* **Waldläufer-Zauber:** 1. Grad: 2 (Standard: *Charm Animal*, *Hide from Animals*)
* **Fertigkeitspunkte:** +7 (Gesamt: 63)
    * *Verteilung:* Knowledge (Nature) 2+2=4, Listen 3+1=4, Spot 5+2=7, Handle Animal 6+1=7, Jump 0+1=1

## Level 7
* **HP:** 63 (7D8 + 7)
* **Rettungswürfe:** Fort 5, Ref 5, Will 2
* **BAB:** +7/+2
* **Klassen-Feature:** Woodland Stride (Sicherer Schritt)
* **Waldläufer-Zauber:** 1. Grad: 2 (Standard: *Magic Fang*, *Resist Energy*)
* **Fertigkeitspunkte:** +7 (Gesamt: 70)
    * *Verteilung:* Knowledge (Geography) 0+5=5, Search 0+2=2

## Level 8
* **Attributserhöhung:** CON +1 *(Erhöht den Konstitutions-Modifikator auf +2, wodurch die HP steigen)*
* **HP:** 72 (8D8 + 8)
...
## Level 9 (Horizon Walker Level 1)
* **HP:** 82 (72 + 8 max HD + 2 CON)
* **Rettungswürfe:** Fort 8, Ref 6, Will 2 *(Ranger 8 Basis: 6/6/2 + HW 1 Basis: 2/0/0)*
